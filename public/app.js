(() => {
  ...
  async function adminMarketingAi(main) {
    ...
    const displayAiModel = legacyModels.includes(String(s.ai_model || '').trim()) || !s.ai_model ? 'gemini-3.1-flash-lite' : s.ai_model;
